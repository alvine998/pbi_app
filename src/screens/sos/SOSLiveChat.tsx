...
export default function SOSLiveChat({ navigation }: { navigation: any }) {
    const insets = useSafeAreaInsets();
    const [messages, setMessages] = useState<Message[]>([
        {
            id: '1',
            text: 'Halo, saya petugas siaga PBI. Ada yang bisa kami bantu dalam keadaan darurat ini?',
            sender: 'admin',
    ...
    const sendMessage = () => {
        ...
        setTimeout(() => {
            const adminResponse: Message = {
                ...
                text: 'Terima kasih atas laporannya. Tim kami sedang memproses informasi Anda. Mohon tetap tenang dan ikuti panduan keselamatan.',
                sender: 'admin',
                timestamp: new Date(),
            };
            ...
            >
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1, marginLeft: normalize(15) }}>
                    <View style={{ width: normalize(40), height: normalize(40), borderRadius: normalize(20), backgroundColor: COLOR.SECONDARY, justifyContent: 'center', alignItems: 'center', marginRight: normalize(12) }}>
                        <Icon name="user-shield" size={normalize(18)} color={COLOR.PRIMARY} solid />
                    </View>
                    <View>
                        <Text style={{ fontSize: normalize(16), fontWeight: '700', color: COLOR.WHITE }}>Admin Siaga PBI</Text>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <View style={{ width: normalize(8), height: normalize(8), borderRadius: normalize(4), backgroundColor: '#4ADE80', marginRight: normalize(5) }} />
                            <Text style={{ fontSize: normalize(12), color: 'rgba(255, 255, 255, 0.8)' }}>Online</Text>
                        </View>
                    </View>
                </View>

                <TouchableOpacity style={{ padding: normalize(10) }}>
                    <Icon name="phone" size={normalize(18)} color={COLOR.WHITE} solid />
                </TouchableOpacity>
            </View>
                ...
                {messages.map((item) => (
                    <View
                        ...
                        style={{
                            ...
                            borderBottomLeftRadius: item.sender === 'admin' ? 2 : normalize(16),
                            maxWidth: '80%',
